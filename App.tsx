  ...
  return (
    <div className="min-h-screen text-gray-800 dark:text-gray-100 flex flex-col items-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <main className="mt-8">
          <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-300 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-grow">
                ...
                <input
                  ...
                  className="w-full bg-gray-200 dark:bg-gray-900 border border-gray-400 dark:border-gray-600 rounded-md py-3 px-4 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-brand-blue focus:border-brand-blue transition duration-200"
                  disabled={!!videoId}
                />
              </div>
              {!videoId ? (
                <button
                  ...
                  className="flex items-center justify-center bg-brand-blue hover:bg-brand-blue-light text-white font-bold py-3 px-4 rounded-md transition duration-200 ease-in-out transform hover:scale-105 disabled:bg-gray-500 disabled:cursor-not-allowed"
                >
                 ...
                 <button
                  onClick={handleReset}
                  className="flex items-center justify-center bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-md transition duration-200 ease-in-out transform hover:scale-105"
                >
          ...
          <div className="mt-8">
            ...
            {videoId && (
              <>
                <div className="bg-black dark:bg-gray-900 rounded-2xl overflow-hidden shadow-2xl border border-gray-300 dark:border-gray-700">
                  <VideoPlayer videoId={videoId} ref={playerRef} theme={theme} />
                </div>
                
                <div className="mt-6 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-gray-300 dark:border-gray-700">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-center">
                        <div className="flex flex-col items-center">
                            <button onClick={handleSetStart} disabled={showPreview} className="flex items-center justify-center w-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-bold py-3 px-4 rounded-md transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                                <SetTimeIcon className="w-5 h-5 mr-2" />
                                Set Start
                            </button>
                            <p className="mt-2 text-2xl font-mono tracking-wider text-green-600 dark:text-green-400">{formatTime(clipStart)}</p>
                        </div>

                        <div className="flex flex-col items-center">
                            <button onClick={handleGenerateClip} disabled={!canGenerate || showPreview} className="flex items-center justify-center w-full bg-brand-blue hover:bg-brand-blue-light text-white font-bold py-3 px-4 rounded-md transition duration-200 disabled:bg-gray-500 disabled:cursor-not-allowed disabled:opacity-50">
                        ...
                        <div className="flex flex-col items-center">
                            <button onClick={handleSetEnd} disabled={showPreview} className="flex items-center justify-center w-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-bold py-3 px-4 rounded-md transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                                <SetTimeIcon className="w-5 h-5 mr-2" />
                                Set End
                            </button>
                            <p className="mt-2 text-2xl font-mono tracking-wider text-red-600 dark:text-red-400">{formatTime(clipEnd)}</p>
                        </div>
                    </div>
                     {clipStart !== null && clipEnd !== null && !canGenerate && (
                         <p className="mt-4 text-yellow-500 dark:text-yellow-400 text-center text-sm">End time must be after start time.</p>
                     )}
                </div>
              </>
            )}
            ...
            {showPreview && canGenerate && videoId && (
                <div className="mt-10 animate-fade-in">
                    <div className="flex flex-col sm:flex-row justify-center items-center text-center mb-4 gap-2 sm:gap-4">
                        ...
                        <span className="font-mono text-lg text-gray-500 dark:text-gray-400 bg-gray-200/50 dark:bg-gray-800/50 px-3 py-1 rounded-md border border-gray-300 dark:border-gray-700">
                    ...
                    <div className="mt-6 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-gray-300 dark:border-gray-700">
                        <h4 className="text-lg font-semibold text-center text-gray-700 dark:text-gray-200">Share Your Clip</h4>
                        <div className="mt-4 flex flex-col sm:flex-row gap-2">
                            ...
                            <button onClick={() => handleCopyLink(shareLink)} className="flex items-center justify-center bg-gray-300 hover:bg-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-bold py-2 px-4 rounded-md transition duration-200">
            ...
            {!isLoading && !videoId && (
                <div className="text-center mt-8 py-16 px-6 bg-gray-200/30 dark:bg-gray-800/30 rounded-2xl border-2 border-dashed border-gray-400 dark:border-gray-700">
                    <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300">Load a video to start clipping</h3>
